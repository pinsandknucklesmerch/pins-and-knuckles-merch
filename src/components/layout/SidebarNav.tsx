...
import { BackgroundAnimationToggle } from "@/components/backgrounds/BackgroundAnimationToggle";
...
export function SidebarNav({ canAdmin, canDeveloper }: SidebarNavProps) {
  ...
  const prefetchFor = (href: string) => pathname === href ? false : undefined;
