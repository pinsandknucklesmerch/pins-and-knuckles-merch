...
function InvoiceCompanyForm({ record, onClose }: { record: InvoiceCompanyRecord | null; onClose: () => void }) {
  ...
  return <Surface className="bg-card/80"><form action={formAction} className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4"><input name="id" value={record?.id ?? ""} readOnly hidden />
