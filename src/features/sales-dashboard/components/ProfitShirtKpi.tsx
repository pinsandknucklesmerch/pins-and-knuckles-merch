...
import { MONTHLY_PROFIT_TARGET, profitProgress } from "../lib/metricDisplay";
...
export function ProfitShirtKpi({ metric }: { metric: MetricResult }) {
  ...
  return (
    <BentoPanel className={styles.card} glow>
      ...
      <div className={styles.shirt}><ProfitShirtMeter value={metric.value} target={MONTHLY_PROFIT_TARGET} /></div>
