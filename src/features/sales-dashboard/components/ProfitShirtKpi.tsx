...
export function ProfitShirtKpi({ metric }: { metric: MetricResult; animationKey?: string | number; animationDelayMs?: number }) {
  ...
  return (
    <Surface variant="metric" className={styles.card}>
      ...
      <div className={styles.shirt}><MonthlyProfitTshirt value={metric.value} target={target} /></div>
