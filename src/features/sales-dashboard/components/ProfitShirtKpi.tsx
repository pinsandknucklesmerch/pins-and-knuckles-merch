...
export function ProfitShirtKpi({ metric, animationKey }: { metric: MetricResult; animationKey?: string | number }) {
  ...
  return (
    <Surface variant="metric" className={styles.card}>
      ...
      <div className={styles.shirt}><ProfitShirtMeter value={metric.value} target={MONTHLY_PROFIT_TARGET} targetState={state} animationKey={animationKey} /></div>
