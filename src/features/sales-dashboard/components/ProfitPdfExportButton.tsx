...
import styles from "./ProfitPdfExportButton.module.css";

type ProfitPdfExportButtonProps = {
  profitTargetRef: RefObject<HTMLElement | null>;
  profitFilename: string;
};

export function ProfitPdfExportButton({ profitTargetRef, profitFilename }: ProfitPdfExportButtonProps) {
  ...
  return (
    <div className={styles.control}>
      <button type="button" className={styles.profitButton} onClick={downloadProfitReport} disabled={isExporting}>
