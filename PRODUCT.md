...
## Users
The primary user is the Pins & Knuckles operator managing garment, calculator, commercial invoice, tax, and reference workflows.

## Constraints
- Keep the interface compact, dark, and operational.
- Avoid marketing pages and decorative hero sections.
